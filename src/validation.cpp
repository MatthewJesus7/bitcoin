...
// δ-framework — otimização ConnectBlock
#include "../../blockchain_otimizer/adapters/bitcoin/adapter_io.h"
#include "../../blockchain_otimizer/adapters/bitcoin/adapter_batch.h"
                               ...
                               CCoinsViewCache& view, bool fJustCheck)
{
    ...
    // ── δ-framework: 1/3 ───────────────────────────────────────────────────
    auto delta_io_tasks = collect_outpoints(block);
